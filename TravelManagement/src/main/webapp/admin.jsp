...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	       <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="admin.jsp" class="nav-link">Admin</a></li>
	        	<li class="nav-item"><a href="customer.jsp" class="nav-link">Customer</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/ka.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container"> <br><br><br><br><br><br><br><br><br>
        <h1 ><b> <center><style=color:blue> <b>Welcome to Admin Login </b></style></center> </b></h1>
