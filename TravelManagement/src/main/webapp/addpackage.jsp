  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="addpackage.jsp" class="nav-link">Add Package</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/ca.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Add Package </h1>
          </div>
        </div>
      </div>
    </section>
						...
						<div class="wrapper">
							<div class="row no-gutters">
								<div class="col-lg-8 col-md-7 d-flex align-items-stretch">
					      		...
					      		<form action="addpackagedata.jsp" method="POST" >
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="number" class="form-control" name="cost" id="nearby" placeholder="Cost">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Days</label>
														<input type="number" name="days" class="form-control" id="contact" placeholder="Days">
													</div></div>
													<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Nights</label>
														<input type="number" name="nights" class="form-control" id="nights" placeholder="Nights">
													</div>
													</div>
													<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Travel Description</label>
														<input type="text" name="traveldescription" class="form-control" id="city" placeholder="Travel Description">
													</div>
													</div>
													<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Places Covered</label>
														<input type="text" name="placescovered" class="form-control" id="city" placeholder="Places Covered">
													</div></div>
													<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Contact Details</label>
														<input type="number" name="contact" class="form-control" id="city" placeholder="Contact Details">
													</div>
													</div>
