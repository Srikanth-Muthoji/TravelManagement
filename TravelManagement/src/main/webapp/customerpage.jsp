  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	       <ul class="navbar-nav ml-auto"><li class="nav-item active"><a href="customerpage.jsp" class="nav-link">Home</a></li>
   ...
   <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container"> <br><br><br><br><br><br><br><br><br>
        <h1 ><b> <center><style=color:blue> <b>Welcome to Customer Page </b></style></center> </b></h1>
