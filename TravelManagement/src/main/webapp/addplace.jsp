  ...
  <body>
	    ...
	    <div class="container">
	     ...
	     <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="addplace.jsp" class="nav-link">Add Place</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center"></div> <b><h1 style="color:black">  </h1></b>
							...
							<div class="row no-gutters">
								<div class="col-lg-8 col-md-7 d-flex align-items-stretch">
									<div class="contact-wrap w-100 p-md-5 p-4">
										<h3 class="mb-4">Add Places</h3>
										<div id="form-message-warning" class="mb-4"></div> 
					      		<form action="addplacedata.jsp" method="POST" >
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nearby" id="nearby" placeholder="Near By">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Contact Details</label>
														<input type="text" name="contact" class="form-control" id="contact" placeholder="Contact Details">
													</div></div>
													<div class="col-md-12">
													<div class="form-group">
