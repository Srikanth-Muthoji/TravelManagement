      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Update Place </h1>
          </div>
        </div>
      </div>
    </section>
    	...
    	%>
					      		...
					      		<form action="updatedata.jsp" method="POST" >
											...
											<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="subject">NearBy</label>
														<input type="text" class="form-control" name="nearby" id="nearby" value="<%= rs.getString(4)%>" placeholder="Near By">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">Contact Details</label>
														<input type="text" name="contact" class="form-control" id="contact" value="<%= rs.getString(5)%>" placeholder="Contact Details">
													</div></div>
													<div class="col-md-12">
													<div class="form-group">
														<label class="label" for="#">Address</label>
														<input type="text" name="address" class="form-control" id="address" value="<%= rs.getString(6)%>" placeholder="Address">
													</div></div>
													<div class="col-md-6">
													<div class="form-group">
														<label class="label" for="#">City</label>
														<input type="text" name="city" class="form-control" id="city" value="<%= rs.getString(7)%>" placeholder="city">
													</div></div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
