...
<html lang="en">
  ...
  <body>
	      ...
	      <ul class="navbar-nav ml-auto">
	       ...
	       <ul class="navbar-nav ml-auto"><li class="nav-item"><a href="customerpage.jsp" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="customerchangepw.jsp" class="nav-link">Change Password</a></li>
	        	<li class="nav-item active"><a href="viewplace1.jsp" class="nav-link">View Places</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/na.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">View Places </h1>
          </div>
        </div><br>
      </div>
    </section>
   ...
   try
{
	...
	out.println("<tr class='table-primary'><th>"+"ID"+"</th>"+"<th>"+"TITLE"+"</th>"+"<th>"+"DESCRIPTION"+"</th>"+"<th>"+"NEARBY"+"</th>"+"<th>"+"CONTACT"+"</th>"+"<th>"+"ADDRESS"+"</th>"+"<th>"+"CITY"+"<th>"+"LIKE"+"</th>"+"</tr>");
	while(rs.next())
	{
		out.println("<tr>");
		out.println("<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getString(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td>"+rs.getString(5)+"</td>"+"<td>"+rs.getString(6)+"</td>"+"<td>"+rs.getString(7)+"</td>");
		out.println("<td><a class='btn btn-primary' href='like1.jsp?id="+rs.getInt(1)+"'><h8>Like</h8></a>"+rs.getInt(8)+"</td>");
