  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="viewpackage.jsp" class="nav-link">View Package</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/services-1.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">View Package </h1>
          </div>
        </div>
      </div>
    </section>
   ...
   try
{
	...
	out.println("<table class='table table-bordered ' > ");
	out.println("<tr class='table-primary'><th>"+"ID"+"</th>"+"<th>"+"TITLE"+"</th>"+"<th>"+"DESCRIPTION"+"</th>"+"<th>"+"COST"+"</th>"+"<th>"+"DAYS"+"</th>"+"<th>"+"NIGHTS"+"</th>"+"<th>"+"TRAVEL DESCRIPTION"+"</th>"+"<th>"+"PLACE COVERED"+"</th>"+"<th>"+"CONTACT"+"</th>"+"<th>"+"DELETE"+"</th>"+"<th>"+"UPDATE"+"</th>"+"</tr>");
	while(rs.next())
		//out.println("<table class='table table-bordered  ' > ");
		...
		
	{
		...
		out.println("<td><a href='delete1.jsp?id="+rs.getInt(1)+"'><h8>Delete</h8></a></td>");
