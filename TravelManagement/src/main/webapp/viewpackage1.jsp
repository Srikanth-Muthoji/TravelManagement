...
<html lang="en">
  ...
  <body>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
 	       <ul class="navbar-nav ml-auto"><li class="nav-item "><a href="customerpage.jsp" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="customerchangepw.jsp" class="nav-link">Change Password</a></li>
	        	...
	        	<li class="nav-item active" ><a href="viewpackage1.jsp" class="nav-link">View Packages</a></li>
	        	<li class="nav-item" active ><a href="ViewBuy.jsp" class="nav-link">View Buy</a></li>
	          <li class="nav-item "><a href="customer.jsp" class="nav-link">Logout</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/love.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">View Packages </h1>
          </div>
        </div>
      </div><br><br>
    </section>
   ...
   try
{
	...
	out.println("<tr class='table-primary'><th>"+"Id"+"</th>"+"<th>"+"Title"+"</th>"+"<th>"+"Description"+"</th>"+"<th>"+"Cost"+"</th>"+"<th>"+"Days"+"</th>"+"<th>"+"Nights"+"</th>"+"<th>"+"Traveldescription"+"</th>"+"<th>"+"Placescovered"+"</th>"+"<th>"+"Contact"+"</th>"+"<th>"+"BUY"+"</th>"+"</tr>");
	while(rs.next())
		//out.println("<table class='table table-bordered  ' > ");
	...
	{
		out.println("<tr>");
		out.println("<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getString(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td>"+rs.getString(5)+"</td>"+"<td>"+rs.getString(6)+"</td>"+"<td>"+rs.getString(7)+"</td>"+"<td>"+rs.getString(8)+"</td>"+"<td>"+rs.getString(9)+"</td>");
		out.println("<td><a href='buy.jsp?id="+rs.getInt(1)+"'><h8>Buy</h8></a></td>");
		//out.println("<td><a href='update1.jsp?id="+rs.getInt(1)+"'><h8>Edit</h8></a></td>");
