	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	       ...
	       <ul class="navbar-nav ml-auto"><li class="nav-item "><a href="customerpage.jsp" class="nav-link">Home</a></li>
	          <li class="nav-item active"><a href="customerchangepw.jsp" class="nav-link">Change Password</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/ca.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="customerchangepw.jsp"></a></span> </p>
            </div>
